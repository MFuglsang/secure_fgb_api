"""
Test Application - FlatGeobuf API med OpenLayers frontend

Dette er en test-version der inkluderer både API'et og en OpenLayers frontend
til at visualisere FlatGeobuf data.

Start med: uvicorn test_app.app:app --reload --port 8001

Åbn derefter: http://127.0.0.1:8001
"""
...
BASE_DIR = Path(__file__).resolve().parent.parent  # Gå op til root
TEST_APP_DIR = BASE_DIR / "test_app"
DATA_DIR = BASE_DIR / "data"  # FlatGeobuf filer (.fgb)
STATIC_DIR = TEST_APP_DIR / "static"  # HTML, CSS, JS filer
